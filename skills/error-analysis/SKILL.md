...
name: error-analysis
description: >
  Entry point for "error analysis" requests. Routes to the targeted skill
  that matches the user's situation. Use when the user asks for error
  analysis without naming a more specific goal. Do NOT use when a more
  specific skill in this plugin already matches; load that skill directly.
---
